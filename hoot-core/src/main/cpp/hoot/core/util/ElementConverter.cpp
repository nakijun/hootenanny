...
boost::shared_ptr<Geometry> ElementConverter::convertToGeometry(const boost::shared_ptr<const Way>& e, bool throwError, const bool statsFlag) const
{
...
boost::shared_ptr<Geometry> ElementConverter::convertToGeometry(const boost::shared_ptr<const Relation>& e, bool throwError, const bool statsFlag) const
{
  GeometryTypeId gid = getGeometryType(e, throwError, statsFlag);
