...
public:
   ...
   */
  boost::shared_ptr<geos::geom::Geometry> convertToGeometry(const boost::shared_ptr<const Element>& e, bool throwError=true, const bool statsFlag=false) const;
  ...
  boost::shared_ptr<geos::geom::Geometry> convertToGeometry(const boost::shared_ptr<const Way>& w, bool throwError, const bool statsFlag=false) const;
  boost::shared_ptr<geos::geom::Geometry> convertToGeometry(const boost::shared_ptr<const Relation>& r, bool throwError, const bool statsFlag=false) const;
