...
private:
  ...
  void _generateFeatureStats(boost::shared_ptr<const OsmMap>& map, QString description, float conflatableCount, MatchCreator::FeatureCalcType type, ElementCriterion* criterion);
};
