...
hoot conflate --debug -D "writer.include.debug=true" -D "conflate.add.score.tags=true" -D "uuid.helper.repeatable=true" test-files/DcTigerRoads.osm test-files/DcTigerRoadsHighwayExactMatchInputs.osm test-output/cmd/ConflateCmdHighwayExactMatchInputsTest/output.osm
