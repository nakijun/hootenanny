...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "hoot_ubuntu1404", primary: true do |hoot_ubuntu1404|
    ...
    hoot_ubuntu1404.vm.synced_folder ".", "/home/vagrant/hoot"
  ...
  config.vm.provider "parallels" do |para, override|
        para.memory = 8192
        para.cpus = 4
        override.hoot_ubuntu1404.vm.box = "parallels/ubuntu-14.04"
        override.hoot_ubuntu1404.vm.box_url = "https://atlas.hashicorp.com/parallels/boxes/ubuntu-14.04"
  end
  ...
  config.vm.provider "vmware_workstation" do |vw, override|
      vw.memory = 8192
      vw.cpus = 4
      override.hoot_ubuntu1404.vm.box = "puphpet/ubuntu1404-x64"
      override.hoot_ubuntu1404.vm.box_url = "https://atlas.hashicorp.com/puphpet/boxes/ubuntu1404-x64"
  end
